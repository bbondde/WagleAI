...
def create_training_instances(
    ...
    max_box_per_image = max([len(inst['object']) for inst in
                             (train_ints + valid_ints)])
...
def create_model(
    ...
    # load the pretrained weight if exists,
    # otherwise load the backend weight only
...
def train_main_(args):
    ...
    if os.path.isfile(config_path):
        ...
        yolo_config_file_exit('fail')

    ###############################
    #   Parse the annotations 
    ###############################
    train_ints, valid_ints, labels, max_box_per_image = \
